<?php foreach($viewVars['productList'] as $currentProduct) : ?>
<section class="page-section">
    ...
    <div class="product-item">
        ...
        <img class="product-item-img mx-auto d-flex rounded img-fluid mb-3 mb-lg-0" src="<?= $currentProduct->image; ?>" alt="">
